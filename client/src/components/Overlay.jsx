    ...
    <>
      ...
      >
        ...
        >
          ...
          <path d="M192.021 4.81381L175.302 23.6356L166.311 23.1251L182.311 4.81378L192.021 4.81381Z" fill="black"/>
          <path d="M192.021 4.81381L175.302 23.6356L166.311 23.1251L182.311 4.81378L192.021 4.81381Z" fill="black"/>
          <path d="M166.241 23.1252L182.408 39.3987L187.332 39.3987L192.255 39.3987L174.5 21.1449L166.241 23.1252Z"
                fill="black"/>
          <path d="M166.241 23.1252L182.408 39.3987L187.332 39.3987L192.255 39.3987L174.5 21.1449L166.241 23.1252Z"
                fill="black"/>
        ...
        <div className="bg-gradient-to-t from-white/90 pt-20 pb-10 p-4 flex items-center flex-col text-center">
          ...
          <p className="text-opacity-60 italic w-1/2">
